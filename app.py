...
ZIP Codes Covered: {metrics['unique_zips']}
Most Common Cause: {metrics['top_cause']}
Highest Activity Month: {metrics['top_month']}

KEY FINDINGS
-------------
• Dataset contains housing-related records.
• {metrics['top_month']} has the highest activity.
